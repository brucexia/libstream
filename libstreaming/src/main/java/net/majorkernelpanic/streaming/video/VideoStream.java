...
public abstract class VideoStream extends MediaStream {
    ...
    CameraDelegate.FrameListener callback;
    ...
    public VideoStream(CameraDelegate delegate) {
        super();
//		setCamera(camera);
...
//                cameraDelegate.getCamera().setPreviewCallbackWithBuffer(null);
            }
...
//            mMediaRecorder.setCamera(cameraDelegate.getCamera());
//            mMediaRecorder.setInputSurface(mSurfaceView);
