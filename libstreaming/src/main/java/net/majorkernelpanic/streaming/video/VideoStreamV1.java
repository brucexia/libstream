 ...
 */
public abstract class VideoStreamV1 extends MediaStream {
	...
	public VideoStreamV1(int camera) {
		super();
//		setCamera(camera);
	}

	public VideoStreamV1(CameraDelegate delegate) {
		super();
//		setCamera(camera);
	 ...
	 * You can get the current state of the flash with {@link VideoStreamV1#getFlashState()}.
	 */
	public synchronized void toggleFlash() {
		cameraDelegate.setFlashState(!mFlashEnabled);
	}
