...
public class CameraDelegateDefaultImpl implements CameraDelegate{
    ...
    public CameraDelegateDefaultImpl(Context context) {
...
//            throw new InvalidSurfaceException("Invalid surface !");
    ...
    protected synchronized void updateCamera() throws RuntimeException {
        ...
        for (CameraDelegateDefaultImpl.FrameListener listener : listners) {
